        ...
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: AppConstants.Layout.sectionSpacing) {
                    ...
                    VStack(spacing: 8) {
                        Text(viewModel.location.isEmpty ? "Location not set" : viewModel.location)
                            .font(.system(size: AppConstants.Typography.sizeTitle, weight: .black))
                            .foregroundColor(.textPrimary)
                            .multilineTextAlignment(.center)
                            .padding(.horizontal, 16)
                    ...
                    Button(action: {
                        isUpdating = true
                        viewModel.updateLocationFromGPS { success, message in
                            isUpdating = false
                            if !success {
            ...
            .alert("Location Update", isPresented: $showingAlert) {
