...
- Create Drift with purpose, approximate location, time, and optional hook.
...
3. Verify center Create opens the Create Drift sheet.
...
- Create - center action that presents Create Drift as a sheet.
...
- A user can open Create Drift from the center action.
